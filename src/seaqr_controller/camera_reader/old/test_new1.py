...
camera.set_control_value(asi.ASI_EXPOSURE, 10000)   # 1ms - FASTEST exposure for 152+ FPS
camera.set_control_value(asi.ASI_GAIN, 150)        # Higher gain to compensate for fast exposure
...
splitter.set_property("max-size-time", 60 * Gst.SECOND)  # 60s per file
