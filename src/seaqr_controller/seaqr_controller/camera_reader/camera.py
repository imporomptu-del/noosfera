...
lib_path = '/usr/local/lib/libASICamera2.so'
...
from seaqr_controller.loger import Publish
from seaqr_controller.config import ConfigLoader

asi.init(lib_path)

CNFGPATH = f'/home/a/Projects/ros2_ws/src/seaqr_controller/config/cameras.yaml'
